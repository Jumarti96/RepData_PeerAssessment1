...
print(paste("Time of highest activity on weekdays: ", Weekday[which.max(Weekday$meansteps), 'interval'], sep=""))
print(paste("Time of highest activity on weekends: ", Weekend[which.max(Weekend$meansteps), 'interval'], sep=""))
